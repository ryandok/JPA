"""
train Baseline Model (ResUnet) on (C1, C0, BreastPred)
Exp5:
Methods -- BSegNet+CSegNet w/o JPA
BSegNet -- Yes
...
parser.add_argument("--exp_name", type=str, default='Baseline_CropZeroDown0.5XY_C1&C0&Breast_DatalistSiemens',
...
parser.add_argument("--img2_prefix", type=str, default='DCE-C0', choices=['DCE-C0', 'Subtraction'], help="img prefix")
...
def train(exp_name,
    ...
    model = ResUnet(in_channels=3, out_channels=2, is_dropput=False).cuda()
