"""
train Baseline Model (ResUnet) on (C1, BreastPred)
Exp4:
Methods -- BSegNet+CSegNet w/o JPA
BSegNet -- Yes
CSegNet Input -- C1&ROI
"""
...
parser.add_argument("--exp_name", type=str, default='Baseline_CropZeroDown0.5XY_C1&Breast_DatalistSiemens',
...
parser.add_argument("--img2_prefix", type=str, default='BreastPred', help="img prefix")
...
def train(exp_name,
    ...
    # dataset
    # training
    volume_key_list_withBreast = ['volume1', 'volume2']
    volume_key_list_withoutBreast = ['volume1']
